...
export const AIRCRAFT: readonly AircraftType[] = [
  {
    id: "helicopter",
    name: "Executive",
    description: "Teardrop cabin · tapered boom · shrouded tail rotor · white and blue",
  ...
  },
  {
    ...
    description: "Strut-braced high wing · tricycle gear · swept fin · white with red cheatline",
  ...
  },
  {
    id: "fighter",
    name: "Interceptor",
    description: "Long nose · thin swept wings · tall fin · white with day-glo orange",
  ...
  },
  {
    id: "airliner",
    name: "Narrow-body",
    description: "Classic twin-jet · small winglets · white with blue cheatline and tail",
  ...
  },
  {
    id: "biplane",
    name: "Sport",
    description: "Compact body · N struts · tight gap · silver with red tail",
  ...
  },
  {
    id: "glider",
    name: "Vintage",
    description: "Gull wings · conventional tail · long canopy · cream and walnut brown",
